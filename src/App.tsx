...
import { useGameStore, selectPhase, selectIsMyTurn, selectMyActions } from './hooks/useGameState';
...
export default function App() {
  ...
  const handleKeyDown = useCallback(
    ...
    [phase, isMyTurn, myActions, hit, stand, doDouble, placeBet, readyForNext, betInput],
  );
